...
@Subselect("select * from infectados where bando ='Heroe'")
public class HeroesInfectados {
	@Id
	...
	public HeroesInfectados() {
		super();
	}
	public HeroesInfectados(String nombrecelula, String nombre, Date fechainfeccion, String bando) {
		super();
		this.nombrecelula = nombrecelula;
		this.nombre = nombre;
		this.fechainfeccion = fechainfeccion;
	...
	public HeroesInfectados(int id, String nombrecelula, String nombre, Date fechainfeccion, String bando) {
		super();
		this.id = id;
		this.nombrecelula = nombrecelula;
		this.nombre = nombre;
