        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                                       <!-- Contact Form -->
                    <form action="/OnePunchMan/guardar1" method="post">
                    <div class="form-group">
								<input type="text" style="visibility: hidden" class="form-control-input" id="id"
									name="id" required value="${patrocinador.id}"/>
							</div>
                        <div class="form-group">
                            	<div class="form-group">
								<input type="text" class="form-control-input" id="nombre"
									name="nombre" required value="${patrocinador.nombre}"> <label class="label-control">Nombre</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="text" class="form-control-input" id="slogan"
									name="slogan" required value="${patrocinador.slogan}"> <label class="label-control">Slogan</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="text" class="form-control-textarea"
									id="descripcion" name="descripcion" required value="${patrocinador.descripcion}"></input>
								<label class="label-control" >Descripcion</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="number" class="form-control-input" id="cantidad"
									name="cantidad" required value="${patrocinador.cantidad}" > <label class="label-control">Cantidad</label>
								<div class="help-block with-errors"></div>
							</div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="/OnePunchMan/Patrocinadores">Atras</a><i class="fa fa-angle-double-right"></i><span>Editar Patrocinadores</span>
