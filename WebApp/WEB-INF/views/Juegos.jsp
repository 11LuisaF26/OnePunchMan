...
$(document).ready( function () {
	...
	<!-- Favicon  -->
    <link rel="icon" href="recursos/images/favicon.png">
</head>
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#Lista">LISTA</a>
                </li>   
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="Jugadores">PARTIDAS</a>
                </li>                    
            </ul>
    ...
    <!-- Header -->
    <header id="header" class="ex-header6">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="CasaSaitama">INICIO</a><i class="fa fa-angle-double-right"></i><span>Lista Juegos</span>
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="text-container">
						...
						<table id="myTable">
							...
							<tbody>
							<c:forEach items="${juegos }" var="juegos">
							<tr>
							<td>${juegos.id }</td>
							<td>${juegos.nombrejuego }</td>
							<td>${juegos.empresa }</td>
							<td>${juegos.rival }</td>
							<td>${juegos.resultado }</td>
							<td>${juegos.favorito }</td>
							<td><a href="EditarJuegos/${juegos.id}" class="btn btn-success btn-sm" role="button" title="EditarJuegos">
							<span class="glyphicon glyphicon-pencil"></span>editar </a> <a href="eliminarJuegos/${juegos.id}"
							onclick='return confirm("¿Estas seguro?")'
							class="btn btn-danger btn-sm" role="button" title="eliminarJuegos">
							<span class="glyphicon glyphicon-trash"></span>eliminar</a></td>
                                  ...
                                  <button type="submit" class="form-control-submit-button2" onclick="location.href='RegistroJuegos'" >Registrar Nuevo juego</button>                        
                </div> <!-- end of col-->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
