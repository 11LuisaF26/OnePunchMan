...
<link rel="stylesheet" href="${pageContext.request.contextPath}/recursos/images/download.jpg">
<link rel="stylesheet" href="${pageContext.request.contextPath}/recursos/images/download-background.jpg">
<link rel="stylesheet" href="${pageContext.request.contextPath}/recursos/images/favicon.jpg">
<link rel="stylesheet" href="${pageContext.request.contextPath}/recursos/images/features-iphone-1.jpg">
<link rel="stylesheet" href="${pageContext.request.contextPath}/recursos/images/features-iphone-2.jpg">
<link rel="stylesheet" href="${pageContext.request.contextPath}/recursos/images/features-iphone-3.jpg">
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/recursos/images/header-background.jpg">
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/recursos/images/video-background.jpg">
<link rel="stylesheet" href="${pageContext.request.contextPath}/recursos/images/video-frame.jpg">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="CasaSaitama">INICIO <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <div id="Registros" class="ex-basic-2">		
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <form action="guardarComida" method="post">
                                       <!-- Contact Form -->                  
                        <div class="form-group">
                            <input type="text" class="form-control-input" id="nombre" name="nombre" required>
                            <label class="label-control" for="cname">Nombre de la comida</label>
                            <div class="help-block with-errors"></div>
                        </div>                        
						<div class="form-group">
                            <input type="number" class="form-control-input" id="cantidad" name="cantidad" required>
                            <label class="label-control" >Cantidad</label>
                            <div class="help-block with-errors"></div>
                        </div>
						<div class="form-group">
                            <input type="date" class="form-control-input" id="fechaconsumo" name="fechaconsumo" required>
                            <label class="label-control" >Fecha de consumo</label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
								<select class="form-control-select" id="consumidor" name="consumidor" required>
									<option class="select-option" value="" disabled selected>Consumidor</option>
                        ...
                        <div class="form-group">
                            <button type="submit" class="form-control-submit-button2">Registrar Comida</button>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="CasaSaitama">INICIO</a><i class="fa fa-angle-double-right"></i><span>Registro Comidas</span><br><br>
						<a href="Comidas">ListaComidas</a><i class="fa fa-angle-double-right"></i><span>Registro Comidas</span>
