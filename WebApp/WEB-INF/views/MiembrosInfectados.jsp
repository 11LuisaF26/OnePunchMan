...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <!-- Header -->
    <header id="header" class="ex-header9">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Miembros Infectados</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="Heroes">Heroes</a><i class="fa fa-angle-double-right"></i><span>Miembros Infectados</span>
    ...
    <div class="ex-basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="Monstruos">Monstruos</a><i class="fa fa-angle-double-right"></i><span>Miembros</span>
                    </div> <!-- end of breadcrumbs -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="text-container">
						...
						<table id="myTable">
							...
							<td><a href="EditarInfectado/${infectados.id}" class="btn btn-success btn-sm" role="button" title="EditarInfectado">
							<span class="glyphicon glyphicon-pencil"></span>editar </a> <a href="EliminarInfectados/${infectados.id}"
							onclick='return confirm("¿Estas seguro?")'
							class="btn btn-danger btn-sm" role="button" title="EliminarInfectados">
    ...
    <div class="ex-basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="Monstruos">Monstruos</a><i class="fa fa-angle-double-right"></i><span>Miembros Infectados</span>
                    </div> <!-- end of breadcrumbs -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
