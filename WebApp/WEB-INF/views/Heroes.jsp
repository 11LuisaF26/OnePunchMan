		...
		<div class="form2">		
			<div class="container">
				...
				<div class="row">
					...
					<form action="guardarHeroe" method="post">						
							<!-- Contact Form -->
							<div class="form-group">
								<input type="text" class="form-control-input" id="nombre" name="nombre"
									required> <label class="label-control" for="name">Nombre</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="text" class="form-control-input" id="rango" name="rango"
									required> <label class="label-control">Rango</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="text" class="form-control-input" id="habilidad" name="habilidad"
									required> <label class="label-control">Habilidad</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="number" class="form-control-input" id="combates" name= "combates"
									required> <label class="label-control">Cantidad
									Combates</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="number" class="form-control-input" id="victorias" name="victorias"
									required> <label class="label-control">Victorias</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="number" class="form-control-input" id="fans" name="fans"
									required> <label class="label-control">Fans</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input type="text" class="form-control-input" id="lugarresidencia" name="lugarresidencia"
									required> <label class="label-control">Lugar
									Residencia</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="number" class="form-control-input"  id="telefono" name="telefono"
									required> <label class="label-control">Telefono</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<select class="form-control-select" id="fande" name="fande">
									<option class="select-option" value="" disabled selected>Es fan de</option>
							...
							<div class="form-group">
								<select class="form-control-select" id="patrocinadorde" name="patrocinadorde">
									<option class="select-option" value="" disabled selected>Patrocinador de</option>
									<c:forEach items="${heroes }" var="heroes">									
									<option value ="${heroes.nombre }"> ${heroes.nombre }</option>									 
									</c:forEach>
							...
							<tbody>
								<c:forEach items="${heroes }" var="heroes">
									<tr>
										...
										<td>${heroes.nombre }</td>
										<td>${heroes.rango }</td>
										<td>${heroes.habilidad }</td>
										<td>${heroes.cantidadcombates }</td>
										<td>${heroes.cantidadvictorias }</td>
										<td>${heroes.fans }</td>
										<td>${heroes.patrocinadores }</td>
										<td>${heroes.lugarresidencia }</td>
										<td>${heroes.telefono }</td>
										<td>${heroes.fande }</td>
										<td>${heroes.patrocinadorde }</td>
										<td><a href="EditarHeroes/${heroes.id}" class="btn btn-success btn-sm" role="button" title="EditarHeroes">
							<span class="glyphicon glyphicon-pencil"></span>editar </a> <a href="eliminarHeroes/${heroes.id}"
