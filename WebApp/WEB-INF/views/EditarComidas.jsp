        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                                       <!-- Contact Form -->
                    <form action="/OnePunchMan/guardar3" method="post">
                    <div class="form-group">
								<input type="text" style="visibility: hidden" class="form-control-input" id="id"
									name="id" required value="${comidas.id}"/>
							</div>
                        <div class="form-group">
                            <input type="text" class="form-control-input" id="nombre" name="nombre" required value="${comidas.nombre}">
                            <label class="label-control" for="cname">Nombre de la comida</label>
                            <div class="help-block with-errors"></div>
                        </div>                        
						<div class="form-group">
                            <input type="number" class="form-control-input" id="cantidad" name="cantidad" required value="${comidas.cantidad}">
                            <label class="label-control" >Cantidad</label>
                            <div class="help-block with-errors"></div>
                        </div>
						<div class="form-group">
                            <input type="date" class="form-control-input" id="fechaconsumo" name="fechaconsumo" required value="${comidas.fechaconsumo}">
                            <label class="label-control" >Fecha de consumo</label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control-input" id="consumidor" name="consumidor" required value="${comidas.consumidor}">
                            <label class="label-control" >Consumidor</label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="form-control-submit-button2">Editar</button>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="/OnePunchMan/Comidas">Atras</a><i class="fa fa-angle-double-right"></i><span>Editar Patrocinadores</span>
