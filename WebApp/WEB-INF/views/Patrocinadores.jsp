...
<!-- Ver de a 25 lineas en la tabla -->
...
<body>
	...
	<!-- Header -->
	<header id="header" class="ex-header3">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<h1>Registro Patrocinadores</h1>
				</div>
				<!-- end of col -->
			</div>
			<!-- end of row -->
						...
						<form action="guardarPatrocinador" method="post">							
							<div class="form-group">
								<input type="text" class="form-control-input" id="nombre"
									name="nombre" required> <label class="label-control"
									for="nombre" >Nombre</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="text" class="form-control-input" id="slogan"
									name="slogan" required> <label class="label-control">Slogan</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input type="number" class="form-control-input" id="cantidad"
									name="cantidad" required> <label class="label-control">Cantidad</label>
								<div class="help-block with-errors"></div>
							</div>
				...
				<div class="col-lg-10 offset-lg-1">
					<div class="text-container">
						...
						<table id="myTable">
							...
							<td>${patrocinador.slogan }</td>
							<td>${patrocinador.descripcion }</td>
							<td>${patrocinador.cantidad }</td>
							<td><a href="edit/${patrocinador.id}" class="btn btn-success btn-sm" role="button" title="Edit">
							<span class="glyphicon glyphicon-pencil"></span>editar </a> <a href="eliminar/${patrocinador.id}"
							onclick='return confirm("¿Estas seguro?")'
							class="btn btn-danger btn-sm" role="button" title="Eliminar">
							<span class="glyphicon glyphicon-trash"></span>eliminar</a></td></c:forEach>
							</tbody>
							</table>
							</div>
					</div>
		...
		<div class="ex-basic-1">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="breadcrumbs">
							<a href="index">INICIO</a><i
								class="fa fa-angle-double-right"></i><span>Registro
								Patrocinadores</span>
						</div>
						<!-- end of breadcrumbs -->
					</div>
