...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <!-- Header -->
    <header id="header" class="ex-header7">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="CasaSaitama">INICIO</a><i class="fa fa-angle-double-right"></i><span>Lista Comidas</span>
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="text-container">
						...
						<table id="myTable">
							...
							<td>${comidas.fechaconsumo }</td>
							<td>${comidas.consumidor }</td>
							<td><a href="EditarComidas/${comidas.id}" class="btn btn-success btn-sm" role="button" title="EditarComidas">
							<span class="glyphicon glyphicon-pencil"></span>editar </a> <a href="eliminarComidas/${comidas.id}"
							onclick='return confirm("¿Estas seguro?")'
							class="btn btn-danger btn-sm" role="button" title="EliminarComidas">
							<span class="glyphicon glyphicon-trash"></span>eliminar</a></td>
                                  ...
                                  <button type="submit" class="form-control-submit-button2" onclick="location.href='RegistroComida'" >Registrar Nueva Comida</button>                        
                </div> <!-- end of col-->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
