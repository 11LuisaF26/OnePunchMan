...
<link rel="stylesheet" href="${pageContext.request.contextPath}/recursos/images/ciudad.jpg">
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><img src="recursos/images/logo.jpg" alt="alternative"></a> 
    ...
    <!-- Header -->
    <header id="header" class="ex-header8">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>PARTIDAS CON KING</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="CasaSaitama.html">INICIO</a><i class="fa fa-angle-double-right"></i><span>Lista Jugadores</span>
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="text-container">
						...
						<table id="myTable">
							...
							<td>${jugadores.nombrejuego }</td>
							
							<td>${jugadores.rival }</td>
							<td>${jugadores.resultado }</td>
