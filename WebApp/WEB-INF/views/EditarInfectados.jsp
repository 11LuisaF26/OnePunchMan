        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                                       <!-- Contact Form -->
                    <form action="/OnePunchMan/guardar2" method="post">
                    <div class="form-group">
								<input type="text" style="visibility: hidden" class="form-control-input" id="id"
									name="id" required value="${infectados.id}"/>
							</div>
                        <div class="form-group">
                               <div class="form-group">
								<input type="text" class="form-control-input" id="nombrecelula" name="nombrecelula"
									required value="${infectados.nombrecelula}"> <label class="label-control">Nombre
									de la celula</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="text" class="form-control-input" id="nombre" name="nombre"
									required value="${infectados.nombre}"> <label class="label-control">Nombre
									del personaje</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="date" class="form-control-input"
									id="fechainfeccion" name="fechainfeccion" required value="${infectados.fechainfeccion}"> <label
									class="label-control">Fecha de Infeccion</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<select class="form-control-select" id="bando" name="bando" required value="${infectados.bando}">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="/OnePunchMan/MiembrosInfectados">Atras</a><i class="fa fa-angle-double-right"></i><span>Editar Infectados</span>
