		...
		<div class="collapse navbar-collapse" id="navbarsExampleDefault">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item"><a class="nav-link page-scroll"
					href="indexl#header">INICIO <span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item"><a class="nav-link page-scroll"
	...
	<div id="Registros" class="ex-basic-2">
		<div class="form7">
			<div class="container">
				...
				<!-- end of row -->
				<form action="guardarJuegos" method="post">
					<div class="row">
						<div class="col-lg-6 offset-lg-3">

							<!-- Contact Form -->
							<div class="form-group">
								<input type="text" class="form-control-input" id="nombrejuego"
									name="nombrejuego" required> <label
									class="label-control">Nombre del juego</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="text" class="form-control-input" id="empresa"
									name="empresa" required> <label class="label-control">Empresa</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<select class="form-control-select" id="rival" name="rival" required>
									<option class="select-option" value="" disabled selected>Rival</option>
							...
							<div class="form-group">
								<select class="form-control-select" id="resultado"
									name="resultado" required>
									<option class="select-option" value="" disabled selected>Resultado
										Batalla</option>
							...
							<div class="form-group">
								<select class="form-control-select" id="favorito"
									name="favorito" required>
									<option class="select-option" value="" disabled selected>Favorito</option>
									<option class="select-option" value="Si">Si</option>
							...
							<div class="form-group">
								<button type="submit" class="form-control-submit-button2">Registrar
									Juego</button>
							</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumbs">
						<a href="CasaSaitama">INICIO</a><i
							class="fa fa-angle-double-right"></i><span>Registro Juegos</span><br>
						<br> <a href="Juegos">ListaJuegos</a><i
							class="fa fa-angle-double-right"></i><span>Registro Juegos</span>
					</div>
					<!-- end of breadcrumbs -->
				</div>
				<!-- end of col -->
