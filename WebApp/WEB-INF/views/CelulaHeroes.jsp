...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <!-- Header -->
    <header id="header" class="ex-header4">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class="ex-basic-1">
        <div class="container">
			<h1>Lista Heroes Infectados</h1>
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index">INICIO</a><i class="fa fa-angle-double-right"></i><span>Lista Heroes Infectados</span>
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="text-container">
						...
						<table  id="myTable">
							...
							<tbody>
							<c:forEach items="${infectados }" var="infectados" varStatus="status">
							<tr>
							<td>${infectados.id }</td>
                  ...
                  <button type="submit" class="form-control-submit-button" onclick="location.href='Infecciones'" >Registrar Nuevo Heroe Infectado</button>                        
                </div> <!-- end of col-->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
