        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                                       <!-- Contact Form -->
                    <form action="/OnePunchMan/guardar4" method="post">
                    <div class="form-group">
								<input type="text" style="visibility: hidden" class="form-control-input" id="id"
									name="id" required value="${heroes.id}"/>
							</div>
                        <div class="form-group">
								<input type="text" class="form-control-input" id="nombre" name="nombre"
									required value="${heroes.nombre}"> <label class="label-control" for="name">Nombre</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="text" class="form-control-input" id="rango" name="rango"
									required value="${heroes.rango}" > <label class="label-control">Rango</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="text" class="form-control-input" id="habilidad" name="habilidad"
									required value="${heroes.habilidad}"> <label class="label-control">Habilidad</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="number" class="form-control-input" id="cantidadcombates" name= "cantidadcombates"
									required value="${heroes.cantidadcombates}"> <label class="label-control">Cantidad
									Combates</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="number" class="form-control-input" id="cantidadvictorias" name="cantidadvictorias"
									required value="${heroes.cantidadvictorias}"> <label class="label-control">Victorias</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="number" class="form-control-input" id="fans" name="fans"
									required value="${heroes.fans}"> <label class="label-control">Fans</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
							<div class="form-group">
								<input type="text" class="form-control-input" id="patrocinadores" name="patrocinadores"
									required value="${heroes.patrocinadores}"> <label class="label-control">Patrocinadores</label>
								<div class="help-block with-errors"></div>
							</div>								
							<div class="form-group">
								<input type="text" class="form-control-input" id="lugarresidencia" name="lugarresidencia"
									required value="${heroes.lugarresidencia}"> <label class="label-control">Lugar
									Residencia</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="number" class="form-control-input"  id="telefono" name="telefono"
									required value="${heroes.telefono}"> <label class="label-control">Telefono</label>
								<div class="help-block with-errors"></div>
							</div>
							<div class="form-group">
								<input type="text" class="form-control-input" id="fande" name="fande" value="${heroes.fande}">
								<label class="label-control">Es fanatico de</label>
							</div>
							<div class="form-group">
								<input type="text" class="form-control-input" id="patrocinadorde" name="patrocinadorde" value="${heroes.patrocinadorde}">
								 <label class="label-control">Es
									patrocinador de</label>
							</div>
							<div class="form-group">
								<button type="submit" class="form-control-submit-button">Editar</button>
							</div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="/OnePunchMan/Heroes">Atras</a><i class="fa fa-angle-double-right"></i><span>Editar Heroes</span>
