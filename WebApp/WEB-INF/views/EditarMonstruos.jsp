        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                                       <!-- Contact Form -->
                    <form action="/OnePunchMan/guardar6" method="post">
                    <div class="form-group">
								<input type="text" style="visibility: hidden" class="form-control-input" id="id"
									name="id" required value="${monstruos.id}"/>
							</div>
                        <div class="form-group">
                            <input type="text" class="form-control-input" id="nombre" name="nombre"required value="${monstruos.nombre}">
                            <label class="label-control" for="nombre">Nombre</label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control-input" id="ciudad" name="ciudad" required value="${monstruos.ciudad}">
                            <label class="label-control" >Ciudad</label>
                            <div class="help-block with-errors"></div>
                        </div>                     		
						<div class="form-group">
                                        <select class="form-control-select" id="nivelamenaza" name="nivelamenaza"required value="${monstruos.nivelamenaza}">
						...
						<div class="form-group">
                                        <select class="form-control-select" id="resultadobatalla" name="resultadobatalla"required value="${monstruos.resultadobatalla}">
						...
						<div class="form-group">
                            <input type="text" class="form-control-input" id="heroeinvolucrado" name="heroeinvolucrado" required value="${monstruos.heroeinvolucrado}">
                            <label class="label-control" >Heroe involucrado</label>
                            <div class="help-block with-errors"></div>
                        </div>
						<div class="form-group">
                                        <select class="form-control-select" id="patrocinadores" name="patrocinadores"required value="${monstruos.patrocinadores}">
                                            <option class="select-option" value="" disabled selected>Patrocinadores</option>
                                            <option class="select-option" value="Adidas">Adidas</option>
                                            <option class="select-option" value="Apple">Apple</option>
											<option class="select-option" value="Discord">Discord</option>
                                        </select>
                                        <div class="help-block with-errors"></div>
                                    </div>                                                
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="/OnePunchMan/Monstruos">Atras</a><i class="fa fa-angle-double-right"></i><span>Editar Monstruos</span>
